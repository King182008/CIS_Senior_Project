...
def doom(hero):
    ...
    slow_print("The tree takes root and but before the the spell is finished the monster unleashes it's hyper beam.")
    slow_print("It pierces the tree, knocks henrik into you and thows both of you into a pile of rubble.")
